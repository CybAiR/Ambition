...
if __name__ == "__main__":
    ...
    model_path = os.path.join(base_dir, "runs", "detect", "depthai_model", "yolo_rocks_btr_opensource", "weights",
                              "best.pt")
    input_video_path = os.path.join(base_dir, "video", "Moon4kNasa_h264.mp4")
    output_video_path = os.path.join(base_dir, "video", "Moon4kNasa_detected.mp4")
