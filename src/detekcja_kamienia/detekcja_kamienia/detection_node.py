...
class YoloV8DetectionNode(Node):
    def __init__(self) -> None:
        ...
        #-------------------ZMIENIC SCIEZKE ABSOLUTNA DO PLIKU MODELU .PT ----------------------------------
        self.declare_parameter('model', '/home/linuxenjoyer/SKAMIELINY/src/detekcja_kamienia/models/yolo_rocks/weights/best.pt')  # Ścieżka do Twojego modelu .pt lub .onnx
