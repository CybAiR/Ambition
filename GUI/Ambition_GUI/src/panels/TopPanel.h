...
class TopPanel
{
  ...
  private:
    ...
    // text
    ImVec4 arm_btn_color_ = ImVec4(0.227f, 0.114f, 0.063f, 1.0f);
    ImVec4 arm_btn_hover_color_ = ImVec4(0.35f, 0.18f, 0.10f, 1.0f);
    ImVec4 arm_btn_border_color_ = ImVec4(0.929f, 0.294f, 0.114f, 1.0f);
    ImVec4 arm_text_color_ = ImVec4(1.000f, 0.678f, 0.420f, 1.0f);
    ...
    void generateViewText(std::string text);
    void generateEStop(const ImGuiViewport* viewport);
    void generateSpeedView(const ImGuiViewport* viewport);
    void generateModeBtn(mode_E& current_mode);
};